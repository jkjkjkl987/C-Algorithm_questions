...
#include <bitset>
#include <stdint.h>
#include <nmmintrin.h>//在 Visual Studio 2022 中，__builtin_popcount 并不是标准的 C 或 C++ 函数，而是 GCC 的扩展功能。
                      //在 Visual Studio 中，你可以使用 _mm_popcnt_u32 和 _mm_popcnt_u64 函数来实现相同的功能，它们分别用于 32 位和 64 位整数。这些函数可以在 <nmmintrin.h> 头文件中找到。
#include <intrin.h>//
using namespace std;
